...
| F6 | correctly rounded `div_nearest` / `recip_nearest` / `RecipTrait::div_nearest` (nalgebra-cairo escalation, 2026-09-23); owner's decision pending on switching `/` itself; release `v0.3.0` | inprogress | |
