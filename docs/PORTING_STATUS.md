...
| F5 | `fixed::wide::Acc` count-agnostic accumulator + `WideSqrt` for `W1..W16` (nalgebra.cairo escalation, 2026-09-23); release `v0.2.0` of the three packages | inreview | #40 |
